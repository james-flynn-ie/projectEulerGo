...
func main() {
	...
	fmt.Printf("before %d %d %d %d", lastfibonaccinumber, currentfibonaccinumber, nextfibonaccinumber, sum)
	...
	fmt.Printf("\nafter %d %d %d %d", lastfibonaccinumber, currentfibonaccinumber, nextfibonaccinumber, sum)
}
